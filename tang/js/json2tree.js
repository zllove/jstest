JSON2Tree = function (ini) {
    ...
    this.json = [
        {text:ini.caption || 'Root', items:ini.json}
    ];
...
JSON2Tree.prototype = {
    ...
    addStyle:function (cssText) {
        ...
        if (n.styleSheet) {
            n.styleSheet.cssText = cssText
        } else if (d.getBoxObjectFor) {
            n.innerHTML += cssText
        } else {
            n.appendChild(d.createTextNode(cssText))
        }
