...
(function (a) {
    a.fn.Jtab = function (d, h) {
        ...
        var b = a.extend({type: "static", auto: false, event: "mouseover", currClass: "curr", source: "data-tag", hookKey: "data-widget", hookItemVal: "tab-item", hookContentVal: "tab-content", stay: 5000, delay: 100, threshold: null, mainTimer: null, subTimer: null, index: 0, compatible: false}, d || {});
...
(function (a) {
    a.fn.Jlazyload = function (j, n) {
        ...
        var f = a.extend({type: null, offsetParent: null, source: "data-lazyload", placeholderImage: "http://misc.360buyimg.com/lib/img/e/blank.gif", placeholderClass: "loading-style2", threshold: 200}, j || {}), k = this, g, m, l = function (r) {
...
(function (a) {
    a.Jtimer = function (d, h) {
        var c = a.extend({pids: null, template: null, reset: null, mainPlaceholder: "timed", subPlaceholder: "timer", resetPlaceholder: "reset", iconPlaceholder: "icon", finishedClass: "", timer: []}, d || {}), g = function (l) {
        ...
        a.ajax({url: "http://qiang.360buy.com/HomePageNewLimitBuy.ashx?callback=?", data: {ids: c.pids}, dataType: "jsonp", success: function (j) {
            if (j && j.data) {
                j.data.sort(b);
...
(function (a) {
    a.fn.Jslider = function (h, n) {
        ...
        var d = a.extend({auto: false, reInit: false, data: [], defaultIndex: 0, slideWidth: 0, slideHeight: 0, slideDirection: 1, speed: "normal", stay: 5000, delay: 150, maxAmount: null, template: null, showControls: true}, h || {});
...
jQuery.fn.pagination = function (a, b) {
    b = jQuery.extend({items_per_page: 10, num_display_entries: 10, current_page: 0, num_edge_entries: 0, link_to: "#", prev_text: "Prev", next_text: "Next", ellipse_text: "...", prev_show_always: true, next_show_always: true, callback: function () {
        return false
    }}, b || {});
...
(function (a) {
    ...
    }, isIE6                   : a.browser.msie && a.browser.version == 6, isMinW: function (b) {
...
(function (a) {
    a.fn.jdMarquee = function (h, b) {
        ...
        var j = a.extend({deriction: "up", speed: 10, auto: false, width: null, height: null, step: 1, control: false, _front: null, _back: null, _stop: null, _continue: null, wrapstyle: "", stay: 5000, delay: 20, dom: "div>ul>li".split(">"), mainTimer: null, subTimer: null, tag: false, convert: false, btn: null, disabled: "disabled", pos: {ojbect: null, clone: null}}, h || {});
...
$.login = function (a) {
    a = $.extend({loginService: "http://passport." + pageConfig.FN_getDomain() + "/loginservice.aspx?callback=?", loginMethod: "Login", loginUrl: "https://passport." + pageConfig.FN_getDomain() + "/new/login.aspx", returnUrl: location.href, automatic: true, complete: null, modal: false}, a || {});
...
(function (a) {
    a.jdCalcul = function (g) {
        ...
        var f = function (n) {
            ...
            var h = function () {
                ...
                a.each(r.pros, function (w) {
                    var A = r.pros[w].id, z = r.pros[w].tp, x = (r.pros[w].zt == 1) ? "<div class='pi9'></div>" : "<div class='pi10'></div>", y = unescape(r.pros[w].mc), u = r.pros[w].qg, v = "(" + r.pros[w].zk + "\u6298)";
        ...
        a.ajax({url: e, dataType: "jsonp", success: function (h) {
            if (h) {
                b = h.data;
                a.each(b, function (j) {
                    f(b[j])
...
var jdRecent = {element: $("#recent ul"), jsurl: "http://www.360buy.com/lishiset.aspx?callback=jdRecent.setData&id=", cookiename: "_recent", list: $.cookie("_recent"), url: location.href, init: function () {
...
var jdModelCallCenter = {settings: {clstag1: 0, clstag2: 0}, tbClose: function () {
    ...
    setTimeout(function () {
        $.jdThickBox({type: "iframe", title: "\u60a8\u5c1a\u672a\u767b\u5f55", source: "http://passport." + pageConfig.FN_getDomain() + "/new/LoginFrame.aspx?clstag1=" + c.settings.clstag1 + "&clstag2=" + c.settings.clstag2 + "&r=" + Math.random(), width: 450, height: 360, _title: "thicktitler", _close: "thickcloser", _con: "thickconr"})
    }, 20)
}, regist                        : function () {
    var a = this;
    this.tbClose();
    setTimeout(function () {
        $.jdThickBox({type: "iframe", title: "\u60a8\u5c1a\u672a\u767b\u5f55", source: "http://passport." + pageConfig.FN_getDomain() + "/new/registPersonalFrame.aspx?clstag1=" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(), width: 450, height: 500, _title: "thicktitler", _close: "thickcloser", _con: "thickconr"})
    }, 20)
}, init                          : function () {
    var a = this;
    $.ajax({url: "http://passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls&sso=0", dataType: "jsonp", success: function (b) {
        a.tbClose();
        if (b && b.info) {
...
$.extend(jdModelCallCenter, {doAttention: function (a) {
    ...
    $.login({modal: true, complete: function (c) {
        if (c != null && c.IsAuthenticated != null && c.IsAuthenticated) {
            if (a > 0) {
                $.getJSON(b, {goodId: a}, function (e) {
                    if (e.code != null) {
                        var g = (e.code == "success") ? 510 : 388, d = (e.code == "success") ? 500 : 80, f = (e.code == "success") ? false : 6;
                        $.jdThickBox({type: "iframe", source: "http://t.360buy.com/subscriber/jumpSubPageNew.action?code=" + e.code + "&pid=" + a + "&t=" + Math.random(), width: g, height: d, title: "\u63d0\u793a", _box: "attboxr", _con: "attconr", _countdown: f})
                    }
                })
            }
        }
...
var category = {OBJ: $("#_JD_ALLSORT"), URL_Serv: "http://www.360buy.com/ajaxservice.aspx?stype=SortJson", URL_BrandsServ: "http://www.360buy.com/lishi.aspx?callback=category.getBrandService&id=a,915,925^b,916,926^c,917,927^d,918,928^e,919,929^f,920,930^g,921,931^h,922,932^i,923,933^j,924,934^k,2096,2097^l,3512,3513^m,5274,5275", FN_GetLink: function (c, d) {
    ...
    {l: "http://book.360buy.com/", n: "\u56fe\u4e66"},
    {l: "http://e.360buy.com/", n: "\u7535\u5b50\u4e66\u520a"},
    {l: "http://mvd.360buy.com/", n: "\u97f3\u50cf"}
], "2"                   : [
    {l: "http://www.360buy.com/electronic.html", n: "\u5bb6\u7528\u7535\u5668"}
], "3"                   : [
    {l: "http://www.360buy.com/digital.html", n: "\u624b\u673a\u6570\u7801"}
], "4"                   : [
    {l: "http://www.360buy.com/computer.html", n: "\u7535\u8111\u3001\u529e\u516c"}
], "5"                   : [
    {l: "http://www.360buy.com/home.html", n: "\u5bb6\u5c45"},
    {l: "http://www.360buy.com/products/1620-1622-000.html", n: "\u5bb6\u5177"},
    {l: "http://www.360buy.com/products/1620-4957-000.html", n: "\u5bb6\u88c5"},
    {l: "http://www.360buy.com/kitchenware.html", n: "\u53a8\u5177"}
], "6"                   : [
    {l: "http://www.360buy.com/clothing.html", n: "\u670d\u9970\u978b\u5e3d"}
], "7"                   : [
    {l: "http://www.360buy.com/beauty.html", n: "\u4e2a\u62a4\u5316\u5986"}
], "8"                   : [
    {l: "http://www.360buy.com/bag.html", n: "\u793c\u54c1\u7bb1\u5305"},
    {l: "http://www.360buy.com/watch.html", n: "\u949f\u8868"},
    {l: "http://www.360buy.com/jewellery.html", n: "\u73e0\u5b9d"}
], "9"                   : [
    {l: "http://www.360buy.com/sports.html", n: "\u8fd0\u52a8\u5065\u5eb7"}
], "10"                  : [
    {l: "http://www.360buy.com/auto.html", n: "\u6c7d\u8f66\u7528\u54c1"}
], "11"                  : [
    {l: "http://www.360buy.com/baby.html", n: "\u6bcd\u5a74"},
    {l: "http://www.360buy.com/toys.html", n: "\u73a9\u5177\u4e50\u5668"}
], "12"                  : [
    {l: "http://www.360buy.com/food.html", n: "\u98df\u54c1\u996e\u6599\u3001\u4fdd\u5065\u98df\u54c1"}
], "13"                  : [
    {l: "http://caipiao.360buy.com/", n: "\u5f69\u7968"},
    {l: "http://trip.360buy.com/", n: "\u65c5\u884c"},
    {l: "http://chongzhi.360buy.com/", n: "\u5145\u503c"},
    {l: "http://game.360buy.com/", n: "\u6e38\u620f"}
...
var UC = {DATA_Cookie: "aview", TPL_UnRegist: '<div class="prompt">			<span class="fl">\u60a8\u597d\uff0c\u8bf7\u767b\u5f55</span>			<span class="fr"><a href="javascript:login()" class="btn-login" clstag="homepage|keycount|home2012|04a">\u767b\u5f55\u4eac\u4e1c</a></span>		</div>', TPL_Regist: '<div class="prompt">				<span class="fl"><strong>${Name}</strong></span>				<span class="fr"><a href="http://home.360buy.com/">\u53bb\u6211\u7684\u4eac\u4e1c\u9996\u9875&nbsp;&gt;</a></span>			</div>', TPL_OList: {placeholder: '<div id="jduc-orderlist"></div>', fragment: '<div class="orderlist">				<div class="smt">					<h4>\u6700\u65b0\u8ba2\u5355\u72b6\u6001\uff1a</h4>					<div class="extra"><a href="http://jd2008.360buy.com/JdHome/OrderList.aspx" target="_blank">\u67e5\u770b\u6240\u6709\u8ba2\u5355&nbsp;&gt;</a></div>				</div>				<div class="smc">					<ul>						{for item in orderList}						<li class="fore${parseInt(item_index)+1}">							<div class="p-img fl">								{for image in item.OrderDetail}									{if image_index<2}										<a href="http://www.360buy.com/product/${image.ProductId}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(image.ProductId)}n5/${image.ImgUrl}" width="50" height="50" alt="${image.ProductName}" /></a>									{/if}								{/for}								{if item.OrderDetail.length>2}									<a href="${item.passKeyUrl}" target="_blank" class="more">\u66f4\u591a</a>								{/if}							</div>							<div class="p-detail fr">								\u8ba2\u5355\u53f7\uff1a${item.OrderId}<br />								\u72b6\u3000\u6001\uff1a<span>${UC.FN_SetState(item.OrderState)}</span><br />								\u3000\u3000\u3000\u3000<a href="${item.passKeyUrl}">\u67e5\u770b\u8be6\u60c5</a>							</div>						</li>						{/for}					</ul>				</div>			</div>'}, TPL_UList: '<div class="uclist">				<ul class="fore1 fl">					<li><a target="_blank" clstag="homepage|keycount|home2012|04b" href="http://jd2008.360buy.com/JdHome/OrderList.aspx">\u5f85\u5904\u7406\u8ba2\u5355<span id="num-unfinishedorder"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04c" href="http://jd2008.360buy.com/user_spzx.aspx">\u54a8\u8be2\u56de\u590d<span id="num-consultation"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04d" href="http://t.360buy.com/home/follow?page=1&m_m=1&r_r=1">\u964d\u4ef7\u5546\u54c1<span id="num-reduction"></span></a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04e" href="http://coupon.360buy.com/user_quan.aspx">\u4f18\u60e0\u5238<span id="num-ticket"></span></a></li>				</ul>				<ul class="fore2 fl">					<li><a target="_blank" clstag="homepage|keycount|home2012|04f" href="http://jd2008.360buy.com/JdHome/OrderList.aspx">\u6211\u7684\u8ba2\u5355&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04i" href="http://t.360buy.com/home/follow">\u6211\u7684\u5173\u6ce8&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04g" href="http://bankws.360buy.com/score/Integral/ScoreExhibit.aspx">\u6211\u7684\u79ef\u5206&nbsp;&gt;</a></li>					<li><a target="_blank" clstag="homepage|keycount|home2012|04h" href="http://my.360buy.com/personal/guess.html">\u4e3a\u6211\u63a8\u8350&nbsp;&gt;</a></li>				</ul>			</div>', TPL_VList: {placeholder: '<div class="viewlist" clstag="homepage|keycount|home2012|04j">				<div class="smt">					<h4>\u6700\u8fd1\u6d4f\u89c8\u7684\u5546\u54c1\uff1a</h4>					<div style="float:right;padding-right:9px;"><a style="border:0;color:#005EA7" href="http://my.360buy.com/history/list.html" target="_blank">\u67e5\u770b\u6d4f\u89c8\u5386\u53f2&nbsp;&gt;</a></div>				</div>				<div class="smc" id="jduc-viewlist">					<div class="loading-style1"><b></b>\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div>					<ul class="lh hide"></ul>				</div>			</div>', fragment: '{for item in list}<li><a href="http://www.360buy.com/product/${item.wid}.html" target="_blank" title="${item.wname}"><img src="${pageConfig.FN_GetImageDomain(item.wid)}n5/${item.imgUrl}" width="50" height="50" alt="${item.wname}" /></a></li>{/for}'}, FN_SetState: function (a) {
    ...
    var f = b.split("|"), a = f.length, e = [], c, d = 0;
    while (d < a) {
        e.push(f[d].split(".")[1]);
        d++
    }
    c = e.join(",");
    $.getJSONP("http://my.360buy.com/product/info.html?ids=" + c + "&jsoncallback=UC.FN_ShowVList")
    ...
    d = d.replace(/(^,*)|(,*$)/g, "");
    $.getJSONP("http://my.360buy.com/product/info.html?ids=" + d + "&jsoncallback=UC.FN_ShowVList")
    ...
    $.ajax({url: "http://minijd.360buy.com/getOrderList", dataType: "jsonp", success: function (b) {
...
var MCART = {DATA_Cookie: "cn", DATA_Amount: readCookie("cn") || 0, URL_Serv: "http://cart.360buy.com/cart/miniCartServiceNew.action", TPL_Iframe: '<iframe scrolling="no" frameborder="0" marginheight="0" marginwidth="0" id="settleup-iframe"></iframe>', TPL_NoGoods: '<div class="prompt">\u8d2d\u7269\u8f66\u4e2d\u8fd8\u6ca1\u6709\u5546\u54c1\uff0c\u8d76\u7d27\u9009\u8d2d\u5427\uff01</div>', TPL_List: {wrap: '<div id="settleup-content"><div class="smt"><h4 class="fl">\u6700\u65b0\u52a0\u5165\u7684\u5546\u54c1</h4></div><div class="smc"></div><div class="smb ar">\u5171<b>${Num}</b>\u4ef6\u5546\u54c1\u3000\u5171\u8ba1<strong>\uffe5 ${TotalPromotionPrice.toFixed(2)}</strong><br><a href="http://cart.360buy.com/cart/cart.html?r=${+new Date}" title="\u53bb\u8d2d\u7269\u8f66\u7ed3\u7b97" id="btn-payforgoods">\u53bb\u8d2d\u7269\u8f66\u7ed3\u7b97</a></div></div>', sigle: '<ul id="mcart-sigle">{for list in TheSkus}	<li>		<div class="p-img fl"><a href="http://www.360buy.com/product/${list.Id}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.Id)}n5/${list.ImgUrl}" width="50" height="50" alt=""></a></div>		<div class="p-name fl"><a href="http://www.360buy.com/product/${list.Id}.html" title="${list.Name}" target="_blank">${list.Name}</a></div>		<div class="p-detail fr ar">			<span class="p-price"><strong>\uffe5${list.PromotionPrice.toFixed(2)}</strong>\u00d7${list.Num}</span>			<br>          {if parseInt(list.FanPrice)>0}			<span class="hl-green">\u8fd4\u73b0\uff1a\uffe5<em>${list.FanPrice}</em></span>			<br>          {/if}          {if parseInt(list.Score)>0}			<span class="hl-orange">\u9001\u79ef\u5206\uff1a<em>${list.Score}</em></span>			<br>          {/if}			<a class="delete" data-id="${list.Id}" data-type="RemoveProduct" href="#delete">\u5220\u9664</a>		</div>      {for jq in list.CouponAD}      <div class="gift-jq">[\u8d60\u5238] \u8d60\u9001${jq.Jing}\u4eac\u5238 ${jq.LimitAd}</a></div>      {/for}	</li>{/for}</ul>', gift: '<ul id="mcart-gift">{for list in TheGifts}	<li>		<div class="p-img fl"><a href="http://www.360buy.com/product/${list.MainSKU.Id}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.MainSKU.Id)}n5/${list.MainSKU.ImgUrl}" width="50" height="50" alt=""></a></div>		<div class="p-name fl"><a href="http://www.360buy.com/product/${list.MainSKU.Id}.html" title="${list.MainSKU.Name}" target="_blank">${list.MainSKU.Name}</a></div>		<div class="p-detail fr ar">			<span class="p-price"><strong>\uffe5${list.PromotionPrice.toFixed(2)}</strong>\u00d7${list.Num}</span>			<br>          {if parseInt(list.FanPrice)>0}			<span class="hl-green">\u8fd4\u73b0\uff1a\uffe5<em>${list.FanPrice}</em></span>			<br>          {/if}          {if parseInt(list.Score)>0}			<span class="hl-orange">\u9001\u79ef\u5206\uff1a<em>${list.Score}</em></span>			<br>          {/if}			<a class="delete" data-id="${list.MainSKU.Id}" data-type="RemoveProduct" href="#delete">\u5220\u9664</a>		</div>      {for gift in list.Skus}      <div class="gift"><a href="http://www.360buy.com/product/${gift.Id}.html" target="_blank">[{if gift.Type==2}\u8d60\u54c1{/if}{if gift.Type==1}\u9644\u4ef6{/if}] ${gift.Name}</a></div>      {/for}      {for jq in list.CouponAD}      <div class="gift-jq">[\u8d60\u5238] \u8d60\u9001${jq.Jing}\u5143\u4eac\u5238 ${jq.LimitAd}</a></div>      {/for}	</li>  {/for}</ul>', suit: '{for suit in TheSuit}<ul id="mcart-suit">	<li class="dt">		<div class="fl"><span>[\u5957\u88c5]</span> ${suit.Name}</div>		<div class="fr"><em>\u5c0f\u8ba1\uff1a\uffe5${(suit.PromotionPrice*suit.Num).toFixed(2)}</em></div>		<div class="clr"></div>	</li>  {for list in suit.Skus}	<li>		<div class="p-img fl"><a href="http://www.360buy.com/product/${list.Id}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.Id)}n5/${list.ImgUrl}" width="50" height="50" alt=""></a></div>		<div class="p-name fl"><span></span><a href="http://www.360buy.com/product/${list.Id}.html" title="${list.Name}" target="_blank">${list.Name}</a></div>		<div class="p-detail fr ar">			<span class="p-price"><strong>\uffe5${list.PromotionPrice.toFixed(2)}</strong>\u00d7${list.Num}</span>			<br>          {if parseInt(list.FanPrice)>0}			<span class="hl-green">\u8fd4\u73b0\uff1a\uffe5<em>${list.FanPrice}</em></span>			<br>          {/if}          {if parseInt(list.Score)>0}			<span class="hl-orange">\u9001\u79ef\u5206\uff1a<em>${list.Score}</em></span>			<br>          {/if}			<a class="delete" data-id="${list.Id}|${suit.Id}" data-type="RemoveSuit" href="#delete">\u5220\u9664</a>		</div>      {for gift in list.Gifts}      <div class="gift"><a href="http://www.360buy.com/product/${gift.Id}.html" target="_blank">[{if gift.Type==2}\u8d60\u54c1{/if}{if gift.Type==1}\u9644\u4ef6{/if}] ${gift.Name}</a></div>      {/for}      {for jq in list.CouponAD}      <div class="gift-jq">[\u8d60\u5238] \u8d60\u9001${jq.Jing}\u5143\u4eac\u5238 ${jq.LimitAd}</a></div>      {/for}	</li>  {/for}</ul>{/for}', mj: '{for mj in ManJian}<ul id="mcart-mj">  <li class="dt">      <div class="fl"><span class="hl-green">\u6ee1\u51cf</span>{if mj.ManFlag} \u5df2\u8d2d\u6ee1${mj.ManPrice}\u5143\uff0c\u5df2\u51cf${mj.JianPrice}\u5143{else}\u8d2d\u6ee1${mj.ManPrice}\u5143\uff0c\u5373\u53ef\u4eab\u53d7\u6ee1\u51cf\u4f18\u60e0{/if}</div>      <div class="fr"><em>\u5c0f\u8ba1\uff1a\uffe5${(mj.PromotionPrice*mj.Num).toFixed(2)}</em></div>      <div class="clr"></div>  </li>  {for list in mj.Skus}  <li>      <div class="p-img fl"><a href="http://www.360buy.com/product/${list.Id}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.Id)}n5/${list.ImgUrl}" width="50" height="50" alt=""></a></div>      <div class="p-name fl"><span></span><a href="http://www.360buy.com/product/${list.Id}.html" title="${list.Name}" target="_blank">${list.Name}</a></div>      <div class="p-detail fr ar">          <span class="p-price"><strong>\uffe5${list.PromotionPrice.toFixed(2)}</strong>\u00d7${list.Num}</span>          <br>          {if parseInt(list.FanPrice)>0}			<span class="hl-green">\u8fd4\u73b0\uff1a\uffe5<em>${list.FanPrice}</em></span>			<br>          {/if}          {if parseInt(list.Score)>0}			<span class="hl-orange">\u9001\u79ef\u5206\uff1a<em>${list.Score}</em></span>			<br>          {/if}			<a class="delete" data-id="${list.Id}|${mj.Id}" data-type="RemoveSuit" href="#delete">\u5220\u9664</a>      </div>      {for gift in list.Gifts}      <div class="gift"><a href="http://www.360buy.com/product/${gift.Id}.html" target="_blank">[{if gift.Type==2}\u8d60\u54c1{/if}{if gift.Type==1}\u9644\u4ef6{/if}] ${gift.Name}</a></div>      {/for}      {for jq in list.CouponAD}      <div class="gift-jq">[\u8d60\u5238] \u8d60\u9001${jq.Jing}\u5143\u4eac\u5238 ${jq.LimitAd}</a></div>      {/for}  </li>  {/for}</ul>{/for}', mz: '{for mz in ManZeng}<ul id="mcart-mz">	<li class="dt">		<div class="fl"><span class="hl-orange">\u6ee1\u8d60</span>          {if mz.ManFlag}              \u5df2\u8d2d\u6ee1${mz.ManPrice}\u5143\uff0c\u60a8{if mz.ManGifts.length>0}\u5df2{else}\u53ef{/if}\u9886\u8d60\u54c1          {else}              \u8d2d\u6ee1${mz.ManPrice}\u5143\uff0c\u5373\u53ef\u9886\u53d6\u8d60\u54c1          {/if}      </div>		<div class="fr"><em>\u5c0f\u8ba1\uff1a\uffe5${(mz.PromotionPrice*mz.Num).toFixed(2)}</em></div>		<div class="clr"></div>	</li>	{for gift in mz.ManGifts}<li class="dt-mz"><a href="${gift.Id}" target="_blank">[\u8d60\u54c1]${gift.Name}</a>\u00d7${gift.Num}</li>{/for}  {for list in mz.Skus}	<li>		<div class="p-img fl"><a href="http://www.360buy.com/product/${list.Id}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(list.Id)}n5/${list.ImgUrl}" width="50" height="50" alt=""></a></div>		<div class="p-name fl"><span></span><a href="http://www.360buy.com/product/${list.Id}.html" title="${list.Name}" target="_blank">${list.Name}</a></div>		<div class="p-detail fr ar">			<span class="p-price"><strong>\uffe5${list.PromotionPrice.toFixed(2)}</strong>\u00d7${list.Num}</span>			<br>          {if parseInt(list.FanPrice)>0}			<span class="hl-green">\u8fd4\u73b0\uff1a\uffe5<em>${list.FanPrice}</em></span>			<br>          {/if}          {if parseInt(list.Score)>0}			<span class="hl-orange">\u9001\u79ef\u5206\uff1a<em>${list.Score}</em></span>			<br>          {/if}			<a class="delete" data-id="${list.Id}|${mz.Id}" data-type="RemoveSuit" href="#delete">\u5220\u9664</a>		</div>      {for gift in list.Gifts}      <div class="gift"><a href="http://www.360buy.com/product/${gift.Id}.html" target="_blank">[{if gift.Type==2}\u8d60\u54c1{/if}{if gift.Type==1}\u9644\u4ef6{/if}] ${gift.Name}</a></div>      {/for}      {for jq in list.CouponAD}      <div class="gift-jq">[\u8d60\u5238] \u8d60\u9001${jq.Jing}\u5143\u4eac\u5238 ${jq.LimitAd}</a></div>      {/for}	</li>  {/for}</ul>{/for}'}, FN_BindEvents: function () {
    ...
    $("#settleup-content .delete").bind("click", function () {
        ...
        $.ajax({url: MCART.URL_Serv, data: c, dataType: "jsonp", success: function (e) {
            if (e.Result) {
                a.FN_Refresh()
            }
        }})
    ...
    var d = b.find("dd").eq(0), c, a = function (h) {
        ...
        if (l > 0) {
            ...
            $("#settleup .ld a").attr("href", "http://cart.360buy.com/cart/cart.html?r=" + (+new Date))
        } else {
    ...
    $.ajax({url: MCART.URL_Serv, data: {method: "GetCart"}, dataType: "jsonp", success: function (e) {
        a(e)
    }});
...
var NotifyPop = {_saleNotify: "http://skunotify.360buy.com/pricenotify.html?", _stockNotify: "http://skunotify.360buy.com/storenotify.html?", init: function (c, e) {
    ...
    var j, b, a, c, g = {skuId: this.sku, pin: this._userPin, webSite: 1, origin: 1, source: 1}, f = this.serializeUrl(location.href);
    ...
    $.jdThickBox({type: "iframe", source: decodeURIComponent(b) + "&nocache=" + (+new Date()), width: 500, height: c, title: j, _box: "notify_box", _con: "notify_con", _title: "notify_title"})
}};
(function () {
    ...
    $.ajax({url: "http://passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls", dataType: "jsonp", scriptCharset: "gb2312", success: function (a) {
        if (a && a.info) {
    ...
    $("#settleup dl").Jdropdown({delay: 200}, function (a) {
        MCART.FN_Refresh();
        $("#settleup .ld a").attr("href", "http://cart.360buy.com/cart/cart.html?r=" + (+new Date))
    });
    $("#my360buy dl").Jdropdown({delay: 100}, function (a) {
        if (a.attr("load")) {
            return
        }
        $.login({automatic: false, complete: function (e) {
            if (!e) {
                return
            }
            var d = a.find("dd").eq(0), c = "", b = readCookie(UC.DATA_Cookie);
...
var $o = (function (g) {
    ...
    var n = "http://dd.search.360buy.com/?key=#{keyword}&uid=#{uid}";
    var m = "#FFDFC6";
    var c = "#FFF";
    var l = $("#key");
    var p = $("#shelper");
    ...
    a.prototype.input = function () {
        ...
        var s = f.replace(n, {keyword: encodeURIComponent(q), uid: encodeURIComponent(r.uid)});
        $.ajax({url: s, dataType: "jsonp", scriptCharset: "utf-8", jsonp: "callback", success: (function (t) {
            return function (u) {
    ...
    a.prototype.onloadItems = function (I) {
        ...
        for (var G = 0, w = I.length; G < w; G++) {
            ...
            if ("string" == typeof(B.cid) && !B.cid.trim().isEmpty()) {
                if (A == false) {
                    A = true;
                    var H = 'style="visibility:hidden"', u = 0;
                    if (B.oamount && B.oamount > 0) {
                        u = B.oamount;
                        H = ""
                    }
                    C += f.replace(k, {id: E, title: B.keyword, keyword: q, amount: u, suggest_pos: K, style: H});
                    E++;
                    K++
                }
                ...
                var s = "item1";
                var t = f.replace(b, {id: E, title: B.keyword, cid: B.cid, cLevel: B.level, className: s, cname: B.cname, amount: B.amount, suggest_pos: K - 1});
                C = f.replace(C, {categorys: t});
                E++
            } else {
                var H = "";
                if (B.amount == 0) {
                    C += f.replace(e, {id: E, title: B.keyword, keyword: q, amount: B.amount, suggest_pos: K})
                } else {
                    C += f.replace(h, {id: E, title: B.keyword, keyword: q, amount: B.amount, suggest_pos: K, style: H})
                }
                E++;
                K++
            }
        ...
        v.length = E;
        y = f.replace(C, {categorys: ""});
        if ("" != y) {
            y += '<li class="close" onclick="$o.hideTip()">\u5173\u95ed</li>';
            p.html(y).show();
            p.find('[id^="d_"]').bind("mouseleave",function () {
                v.mouseleave($(this))
    ...
    a.prototype.bind_input = function () {
        if ($.browser.mozilla) {
            l.bind("keydown", function (q) {
                j.keydown_up(q)
            });
            l.bind("input", function (q) {
                j.input(q)
            })
        } else {
    ...
    a.prototype.del = function (s) {
        ...
        var t = $(s.srcElement ? s.srcElement : s.target), q = t.parent().parent().attr("title");
        $.ajax({url: "http://search.360buy.com/suggest.php?op=del&callback=?&key=" + encodeURIComponent(q), dataType: "jsonp", scriptCharset: "utf-8", success: function (u) {
...
pageConfig.FN_InitContrast = function (d, c, b) {
    var d = d || "_contrast", b = b || "list", c = c || "http://misc.360buyimg.com/contrast/js/contrast.js?ver=" + (+new Date), a = readCookie(d + "_status");
...
if (self !== top) {
    $("body").append('<iframe src="http://guang.360buy.com/static/cross-domain.html" style="display:none;"></iframe>')
}
;