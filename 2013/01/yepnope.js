...
(function (window, doc, undef) {
    ...
    var docElement = doc.documentElement,
        ...
        insBeforeObj = isGeckoLTE18 ? docElement : firstScript.parentNode, // Thanks to @jdalton for showing us this opera detection (by way of @kangax) (and probably @miketaylr too, or whatever...)
    ...
    yepnope = function (needs) {
        var i,
            need, // start the chain as a plain instance
